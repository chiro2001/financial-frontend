...
impl FinancialAnalysis {
    ...
    pub fn init(mut self) -> Self {
        ...
        execute(async move {
            ...
            let base_url = format!("http://127.0.0.1:{}", 51411); // URL of the gRPC-web server
            // let query_client = ApiRpcClient::new(Client::new(base_url)); // `QueryClient` is the client generated by tonic
